...
<spring:url value="/user/payment/service/mobile/${name}/pay" var="payUrl"/>
        ...
        <c:if test="${!empty accountList}">
            ...
            <div class="row margin-top5">
                <div class="col-sm-3 col-sm-offset-3">
                    <label class="payment-inf">${phoneNumber}</label>
                </div>
                <div class="col-sm-3">
            ...
            <div class="row">
                <div class="col-sm-3 col-sm-offset-3">
                    <form:input class="form-control form-control-moresize" path="phoneNumber"
