    ...
    function An(e, t, n) {
        ...
        for (r in t)if (i = t[r], wn.exec(i)) {
            if (delete t[r], o = o || "toggle" === i, i === (f ? "hide" : "showWindow")) {
                if ("showWindow" !== i || !h || h[r] === undefined)continue;
                f = !0
            }
    ...
    }, x.each(["toggle", "showWindow", "hide"], function (e, t) {
        var n = x.fn[t];
